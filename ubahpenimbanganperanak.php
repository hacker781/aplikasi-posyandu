...
<head>
<title>Posyandu Tulip - Ubah Data Anak</title>
...
<?php
 $data=mysql_query("SELECT pemeriksaan.id_anak, pemeriksaan.tanggal_pemeriksaan, pemeriksaan.berat_badan, pemeriksaan.tinggi_badan FROM pemeriksaan INNER join anak on anak.id_anak = pemeriksaan.id_anak ");
                     
                      $no=1;
                      
                      $syarat=$_GET['id_anak'];
                      $data=mysql_query("SELECT * FROM pemeriksaan WHERE id_anak='$syarat' ORDER BY id_pemeriksaan");
                      while ($r=mysql_fetch_array($data)) {
                       ?>
                       
                       
                      <div class="card-body card-block">
                        <form action="updatepenimbanganperanak.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                          
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label"></label></div>
                            <div class="col-12 col-md-9"><input type="hidden" class="form-control" name="id_anak"  value="<?php echo $r['id_anak']; ?>"></div>
                          </div>
                          
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label"></label></div>
                            <div class="col-12 col-md-9"><input type="hidden" class="form-control" name="id_pemeriksaan"  value="<?php echo $r['id_pemeriksaan']; ?>"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal Penimbangan</label></div>
                            <div class="col-12 col-md-9"><input type="date" class="form-control" name="tanggal_pemeriksaan"  value="<?php echo $r['tanggal_pemeriksaan']; ?>"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Berat Badan</label></div>
                            <div class="col-12 col-md-9"><input type="text" class="form-control" name="berat_badan"  value="<?php echo $r['berat_badan']; ?>"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tinggi Badan</label></div>
                            <div class="col-12 col-md-9"><input type="text" class="form-control" name="tinggi_badan"  value="<?php echo $r['tinggi_badan']; ?>"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Lingkar Kepala</label></div>
                            <div class="col-12 col-md-9"><input type="text" class="form-control" name="lingkar_kepala"  value="<?php echo $r['lingkar_kepala']; ?>"></div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            if ($y==1) {
                               ...
                               <input type="checkbox" name="perilaku[]" value="Berdiri dan berjalan berpegangan">Berdiri dan berjalan berpegangan<br>
                                 ...
                                 echo '<p color="red">7 sampai 9 bulan</p>
                               ...
                               echo '<p color="red">0 sampai 6 bulan</p>
                                     <input type="checkbox" name="perilaku[]" value="Menatap ke ibu">Menatap ke ibu<br>
                                     <input type="checkbox" name="perilaku[]" value="mengeluarkan suara 0..0..">mengeluarkan suara 0..0..<br>
                                     <input type="checkbox" name="perilaku[]" value="tersenyum">tersenyum<br>
                                      <input type="checkbox" name="perilaku[]" value="Menggerakan tangan dan kaki">Menggerakan tangan dan kaki<br>
