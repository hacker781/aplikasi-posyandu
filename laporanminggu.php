...
?>
<h4 style="text-align: center;">LAPORAN PENIMBANGAN PER PERIODE</h4><hr><br>


  
   <div class="card-body card-block">
                        <form action="laporan/dataminggu.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="col-12 col-md-9">
                              <select  name="tanggal_pemeriksaan" class="form-control ">
                                <option value="">Tanggal-Bulan-Tahun</option>
                                  <?php
                                    include "koneksi.php";
                                    $sqllomba = "SELECT * FROM pemeriksaan WHERE id_anak='1'";
