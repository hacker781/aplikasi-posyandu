...
<head>
<title>Posyandu Tulip - Anak</title>
...
&nbsp  &nbsp<a href="tambahdata.php" ><input type="submit" class="btn btn-primary btn-fw" value="tambah"></a>&nbsp  &nbsp<a href="penimbangan.php" ><input type="submit" class="btn btn-primary btn-fw" value="Lihat per anak"></a>
<br>
<br>
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                     <?php 
                        ...
                        $data = mysql_query("select * from penimbangan ");   
