    ...
    <section id="slider"><a href="#"><img src="" alt=""></a></section>
     <div class="card">
                      ...
                      <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="id_anak" placeholder="Masukan Berat Badan" class="form-control"></div>
                          </div>


                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal Penimbangan</label></div>
                            <div class="col-12 col-md-9"><input type="date" id="text-input" name="tanggal_penimbangan" placeholder="Masukan Nama" class="form-control"></div>
                          </div>
