        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                 <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="grafikberatbadankeseluruhan.php"> <i class="menu-icon ti-anchor"></i>Grafik BB</a>
                    </li>
                     <li>
                        <a href="grafiktinggibadankeseluruhan.php"> <i class="menu-icon ti-anchor"></i>Grafik TB</a>
                    </li>
                    <li>
                        <a href="grafiklingkarkepalakeseluruhan.php"> <i class="menu-icon ti-anchor"></i>Grafik Lingkar Kepala</a>
                    </li>
                </ul>
            </div><!-- nav -->
        </nav>
        ...
        <header id="header" class="header">
            ...
            <div class="content mt-6">
                <div class="animated fadeIn">
                    <div class="row">
                    <img src="4.jpg" alt="" align="Center">
                      <div class="col-md-12">
