                    ...
                    <tbody>
                     <?php
                      ...
                      while ($r=mysql_fetch_array($data)) {
                       ...
                       <td><a href='ubahdataadmin.php?id_admin=<?php echo $r['id_admin'];?>'><input type="button" class="btn btn-outline-primary" value="ubah"></a>&nbsp<a href='hapusdataadmin.php?id_admin=<?php echo $r['id_admin'];?>'><input type="button" class="btn btn-outline-primary" value="hapus"></a></td>
                      </tr>
                       <?php
                      }
                      ?>
