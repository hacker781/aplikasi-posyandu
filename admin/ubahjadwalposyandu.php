...
include 'koneksi.php';
 ?>
  ...
  <?php
    ...
    $data=mysql_query("SELECT * from jadwal_posyandu WHERE id_jadwal_posyandu='$id_jadwal_posyandu'");
    while ($r=mysql_fetch_array($data)) {
     ?>
                      <div class="card-body card-block">
                        <form action="updatedataadmin.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                          <div class="row form-group">
                            <div class="col col-md-3">
                                <input type="hidden" class="form-control" name="id_jadwal_posyandu" value="<?php echo $r['id_jadwal_posyandu']; ?>">
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tanggal Posyandu</label></div>
                            <div class="col-12 col-md-9"><input type="text" class="form-control" name="tanggal_posyandu"  value="<?php echo $r['tanggal_posyandu']; ?>"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Keterangan</label></div>
                            <div class="col-12 col-md-9"><input type="text" class="form-control" name="keterangan"  value="<?php echo $r['keterangan']; ?>"></div>
                          </div>
