...
<head>
    ...
    <title>Posyandu Tulip - Admin - Data Admin</title>
...
?>
 ...
 &nbsp  &nbsp
 <a href="tambahjadwalposyandu.php" >
    <input type="submit" class="btn btn-primary btn-fw" value="Tambah Data">
</a>
<br>
<br>
            ...
            <div class="card">
                ...
                <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                     <?php
                      $data=mysql_query("SELECT * FROM jadwal_posyandu");
                      $no=1;
                      while ($r=mysql_fetch_array($data)) {
                       ?>
                        <tr>
                       <td><?php echo $no++ ?></td>
                       <td><?php echo $r['tanggal_posyandu']; ?></td>
                       <td><?php echo $r['ket']; ?></td>
                       <td><a href='cek.php'><input type="button" class="btn btn-outline-primary" value="cek"></a></td>
                       <td><a href='ubahjadwalposyandu.php?id_jadwal_posyandu<?php echo $r['id_jadwal_posyandu'];?>'><input type="button" class="btn btn-outline-primary" value="ubah"></a>&nbsp<a href='hapusjadwalposyandu.php?id_jadwal_posyandu=<?php echo $r['id_jadwal_posyandu'];?>'><input type="button" class="btn btn-outline-primary" value="hapus"></a></td>
                      </tr>
                       <?php
                      }
                      ?>
