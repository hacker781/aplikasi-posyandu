          ...
          <div class="col-md-12">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <form action="insertjadwalposyandu.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="date" id="text-input" name="tanggal_posyandu" placeholder="Masukan Nama" class="form-control"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Keterangan</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="ket" placeholder="Masukan Nama" class="form-control"></div>
                          </div>
