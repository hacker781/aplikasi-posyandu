                    ...
                    <div class="card">
                        ...
                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="username" placeholder="Masukan Username dengan abjad A-Z tidak menggunakan spasi" class="form-control"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Password</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="password" placeholder="Masukan Password minimal 8 digit" class="form-control"></div>
                          </div>
                          ...
                          <button type="submit" name="simpan" class="btn btn-primary btn-fw">Simpan Data</button>
                        </form>
                    </div>
                </div> 
            </div>
...
//proses
    ...
    if(empty($nama)){
        ...
        window.location='tambahdataadmin.php'</script>";
        break;
    }
    if(empty($username)){
    ...
    $cek=mysql_num_rows(mysql_query("SELECT * FROM admin WHERE nama='$nama' or username='$username'"));
    ...
    window.location='tambahdataadmin.php'</script>";
      ...
      mysql_query("INSERT INTO admin VALUES('', '$nama','$username','$password','$jenis_kelamin','$alamat','$no_telp', '$hak_akses')") or die(mysql_error());{
