...
<head>
    ...
    <title>Posyandu Tulip - Admin - Ubah Data</title>
                      ...
                      <div class="card-body card-block">
                        <form action="updatedataanak.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" class="form-control" name="nama_anak"  value="<?php echo $r['nama_anak']; ?>"></div>
                          </div>
                          ...
                          <div class="row form-group">
                           ...
                           <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Berat Badan Lahir</label></div>
                            <div class="col-12 col-md-9"><input type="text" class="form-control" name="berat_badan_lahir"  value="<?php echo $r['berat_badan_lahir']; ?>"></div>
                          </div>

                           <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tinggi Badan Lahir</label></div>
                            <div class="col-12 col-md-9"><input type="text" class="form-control" name="tinggi_badan_lahir"  value="<?php echo $r['tinggi_badan_lahir']; ?>"></div>
                          </div>

                           <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Lingkar Kepala Lahir</label></div>
                            <div class="col-12 col-md-9"><input type="text" class="form-control" name="lingkar_kepala_lahir"  value="<?php echo $r['lingkar_kepala_lahir']; ?>"></div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" class="form-control" name="nohp"  value="<?php echo $r['nohp']; ?>"></div>
                          </div>
