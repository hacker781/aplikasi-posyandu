...
$tanggal_pemeriksaan       = mysqli_query($koneksi, "SELECT tanggal_pemeriksaan FROM pemeriksaan WHERE tanggal_pemeriksaan='2019-04-10'");
$lingkar_kepala = mysqli_query($koneksi, "SELECT lingkar_kepala FROM pemeriksaan WHERE tanggal_pemeriksaan='2019-04-10'");
?>
