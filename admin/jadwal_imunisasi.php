                 ...
                 <ul class="nav navbar-nav">
                    ...
                    <li>
                     ...
                     <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon ti-calendar"></i>Jadwal Imunisasi</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li>
                                <i class="fa fa-puzzle-piece"></i>
                                <a href="jadwal_sudah.php">Sudah Selesai Imunisasi Dasar</a>
                            </li>
                            <li>
                                <i class="fa fa-puzzle-piece"></i>
                                <a href="jadwal_belum.php">Belum Selesai Imunisasi Dasar</a>
                            </li>
                        </ul>
                    </li>
