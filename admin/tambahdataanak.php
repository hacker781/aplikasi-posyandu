                      ...
                      <div class="card-body card-block">
                        <form action="insertdataanak.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="berat_badan_lahir" placeholder="Masukan Berat Badan Lahir" class="form-control"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tinggi Badan Lahir</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="tinggi_badan_lahir" placeholder="Masukan Tinggi Badan Lahir" class="form-control"></div>
                          </div>

                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Lingkar Kepala Lahir</label></div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="lingkar_kepala_lahir" placeholder="Masukan Lingkar Kepala Lahir" class="form-control"></div>
                          </div>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="nohp" placeholder="Masukan Nomer Telephone" class="form-control"></div>
                          </div>
